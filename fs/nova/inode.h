...
extern int nova_notify_change(struct mnt_idmap *mnt_idmap, struct dentry *dentry, struct iattr *attr);
extern int nova_getattr(struct mnt_idmap *mnt_idmap, const struct path *path, struct kstat *stat,
